...
\begin{enumerate}
	...
	\end{figure}
	\item Varying the PER degradation rate: See Figure \ref{fig:oscillation grid vd}
	\begin{figure}[!htbp]
		\centering
		\subfloat{
	...
	\end{figure}
	\item Varying the mRNA degradation rate: See Figure \ref{fig:oscillation grid vm}
	\begin{figure}[!htbp]
		\centering
		\subfloat{
